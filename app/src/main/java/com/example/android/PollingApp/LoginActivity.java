            ...
            public void onClick(View view) {
               ...
               // Toast.makeText(LoginActivity.this, "PROCESSING....", Toast.LENGTH_LONG).show();
                ...
                if (!TextUtils.isEmpty(email)&& !TextUtils.isEmpty(password)){
                    ...
                    mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                Toasty.error(LoginActivity.this, "User Not Found!", Toast.LENGTH_SHORT, true).show();
                    ...
                    Toasty.error(LoginActivity.this, "Complete all Fields!", Toast.LENGTH_SHORT, true).show();
